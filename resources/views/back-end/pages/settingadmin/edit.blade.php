                                    ...
                                    <div class="card shadow-sm"
                                        ...
                                        <div class="card-header text-center"
                                            ...
                                            <h4 class="mb-0" style="font-size: 1.75rem; font-weight: 600; color:#fff;">
                                                <i class="fa-solid fa-wrench fs-2" style="margin-right: 10px;"></i>  แก้ไขข้อมูลผู้ดูแลระบบ</h4>
                                        </div>
                                        <div class="card-body p-4" style="background-color: #f7f9fc;">
                                            <form action="{{ route('settingadmin.update', $item->id) }}" method="POST">
                                                @csrf
                                                @method('POST') <!-- หากไม่ต้องการเปลี่ยนเป็น PUT/PATCH -->
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control" id="email" name="email" placeholder="กรอก Username"
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <select class="form-select" id="role_name" name="role_name" required>
                                                        <option value="Admin" {{ old('role_name', $item->role_name) == 'Admin' ? 'selected' : '' }}>Admin</option>
                                                        <option value="User" {{ old('role_name', $item->role_name) == 'User' ? 'selected' : '' }}>User</option>
                                                    </select>
                                                </div>
