                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                <div class="container mt-5">
                                    <h2 class="text-center mb-4 text-primary">
                                        เพิ่มตั้งค่าข้อมูลเงื่อนไขการคืนเงินการยกเลิก</h2>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form id="form_submit" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div class="">
                                                <button type="reset" onclick="history.back()" class="btn btn-light btn-active-light-primary me-2">ยกเลิก</button>
                                                <a href="javascript:void(0)" class="btn btn-primary" id="submit" onclick="check_add()">บันทึก</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
